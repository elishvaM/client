  ...
  return (<>
    ...
    <div style={{ display: 'block' }}>
      <ul style={{
        ...
        {attractionsDay?.map((attractions, key) => <li key={key} style={{padding:20}}
        ><OneDayInTrip dayinWeek={attractions.dayinWeek} date={attractions.date} attractionsDay={attractions.trips} /></li>
        )}
      </ul>
    </div>
  </>);
